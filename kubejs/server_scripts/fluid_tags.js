...
const setFluidTags = (fluidTagsEvent) => {
    fluidTagsEvent.get('minecraft:water').removeAll().add([/^(minecraft|tfc):.*water$/])
    ...
    fluidTagsEvent.get('tfc:usable_in_barrel').add('immersiveengineering:creosote')
    fluidTagsEvent.get('forge:chocolate').add('firmalife:chocolate')
    fluidTagsEvent.get('forge:milk').removeAll().add(["firmalife:yak_milk", "firmalife:goat_milk", "firmalife:coconut_milk"])
