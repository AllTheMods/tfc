...
const removeRecipes = (recipesEvent) => {
  ...
  recipesEvent.remove({
    ...
    not: { id: /.*ens_emerald_mesh/ }
  })
  recipesEvent.remove({
    mod: "exnihilosequentia",
    type: "minecraft:smithing",
    not: { id: /.*ens_netherite_mesh/ }
  })
  ...
  recipesEvent.remove({
    mod: "exnihilosequentia",
    input: "exnihilosequentia:silkworm"
  })
  ...
  recipesEvent.remove({
    id: "immersiveengineering:smelting/ingot_steel_from_dust"
  })
  ...
  recipesEvent.remove({
    output: Item.of("tombstone:fishing_rod_of_misadventure").ignoreNBT()
  })
  ...
  recipesEvent.remove({
    id: "thermal:machines/insolator/insolator_dark_oak_sapling"
  })
  recipesEvent.remove({
    id: "thermal:machines/insolator/insolator_jungle_sapling"
  })
  ...
  recipesEvent.remove({
    id: "thermal:machines/press/unpacking/press_wheat_unpacking"
  })
  ...
  for (const woodType of vanillaWoodTypes) {
    recipesEvent.replaceInput(
      { id: `create:${woodType}_window` },
      `minecraft:${woodType}_planks`,
      `tfc:wood/planks/${woodType}`
    )
    recipesEvent.remove({
      id: `thermal:machines/insolator/insolator_${woodType}_sapling`
    })
  }
  for (const material of materials) {
    ...
    recipesEvent.remove({
      id: `immersiveengineering:sawmill/${material}_stairs`
    })
    recipesEvent.remove({ id: `immersiveengineering:sawmill/${material}_door` })
    recipesEvent.remove({
      id: `immersiveengineering:sawmill/stripped_${material}_log`
    })
  ...
  for (const vanillaWood of vanillaWoodTypes) {
    ...
    recipesEvent.remove({
      id: `thermal:machines/sawmill/sawmill_${vanillaWood}_logs`
    })
  }
  ...
  recipesEvent.remove({
    ...
    not: { id: "integrateddynamics:special/facade" }
  })
  recipesEvent.remove({
    id: "integrateddynamics:drying_basin/convenience/minecraft_dried_kelp"
  })
  recipesEvent.remove({
    id: "integrateddynamics:mechanical_drying_basin/convenience/minecraft_dried_kelp"
  })
  recipesEvent.remove({ id: "minecraft:dried_kelp" })
  recipesEvent.remove({
    id: "thermal:machines/press/unpacking/press_dried_kelp_unpacking"
  })
...
const setRecipes = (recipesEvent) => {
  ...
  recipesEvent.replaceInput(
    { type: "minecraft:crafting_shaped", mod: "create" },
    "minecraft:oak_planks",
    "#minecraft:planks"
  )
  recipesEvent.replaceInput(
    { input: "minecraft:cobblestone", mod: "create" },
    "minecraft:cobblestone",
    "#forge:cobblestone/normal"
  )
  recipesEvent.replaceInput(
    { input: "minecraft:smooth_stone", mod: "create" },
    "minecraft:smooth_stone",
    "#tfc:rock/smooth"
  )
  recipesEvent.replaceInput(
    { input: "minecraft:stone_slab" },
    "minecraft:stone_slab",
    "#tfc:raw_rock_slabs"
  )
  recipesEvent.replaceInput(
    { input: "minecraft:deepslate", mod: "supercircuitmaker" },
    "minecraft:deepslate",
    "#tfc:rock/smooth"
  )

  recipesEvent.recipes.thermal
    .insolator(
      [
        Item.of("tfc:jute").withChance(2),
        Item.of("tfc:seeds/jute").withChance(1.1)
      ],
      "tfc:seeds/jute"
    )
    .water(900)
  ...
  for (const fern of ferns) {
    recipesEvent.custom({
      ...
      ingredients: [Ingredient.of(`tfc:plant/${fern}_fern`).toJson()],
      results: [
  ...
  for (const log of logs) {
    ...
    recipesEvent.recipes.immersiveengineeringSawmill(
      plankOutput,
      Item.of(`tfc:wood/log/${log}`),
      secondary,
      Item.of(`tfc:wood/stripped_log/${log}`)
    )
    recipesEvent.recipes.immersiveengineeringSawmill(
      plankOutput,
      Item.of(`tfc:wood/stripped_log/${log}`),
    ...
    recipesEvent.recipes.immersiveengineeringSawmill(
      plankOutput,
      Item.of(`tfc:wood/wood/${log}`),
      secondary,
      Item.of(`tfc:wood/stripped_wood/${log}`)
    )
    recipesEvent.recipes.immersiveengineeringSawmill(
      `4x tfc:wood/lumber/${log}`,
      `tfc:wood/planks/${log}`
    )

    recipesEvent.recipes.thermal.sawmill(
      [Item.of("#forge:dusts/wood").withChance(1.25), plankOutput],
      `tfc:wood/stripped_wood/${log}`
    )
    recipesEvent.recipes.thermal.sawmill(
      [
    ...
    recipesEvent.recipes.createCutting(
      [
        Item.of(`tfc:wood/stripped_log/${log}`),
        Item.of("#forge:dusts/wood").withChance(0.25)
      ],
      Item.of(`tfc:wood/log/${log}`)
    )
    recipesEvent.recipes.createCutting(
      [plankOutput, Item.of("#forge:dusts/wood").withChance(0.25)],
      Item.of(`tfc:wood/stripped_log/${log}`)
    )
    recipesEvent.recipes.createCutting(
      [
    ...
    recipesEvent.recipes.thermal
      .insolator(
        [
          Item.of(`tfc:wood/log/${log}`).withChance(4),
          Item.of(`tfc:wood/sapling/${log}`).withChance(1.1),
          Item.of(`tfc:wood/twig/${log}`).withChance(2)
        ],
        `tfc:wood/sapling/${log}`
      )
      .water(1000)
  }
  ...
  recipesEvent
    .custom({
      type: "create:crushing",
      ingredients: [Ingredient.of("apotheosis:gem")],
      results: [{ item: "apotheosis:gem_dust" }],
      processingTime: 400
    })
    .id(`kubejs:crushing/gem_dust`)

  recipesEvent.recipes.createPressing(
    "tfc:refined_iron_bloom",
    Ingredient.of("tfc:raw_iron_bloom").ignoreNBT()
  )
  recipesEvent.recipes.createPressing(
    "tfc:metal/ingot/wrought_iron",
    Ingredient.of("tfc:refined_iron_bloom").ignoreNBT()
  )
  ...
  for (const sheetMetal of sheetAndDoubleIngotMetals) {
    ...
    recipesEvent.recipes.immersiveengineeringMetalPress(
      Ingredient.of(`tfc:metal/sheet/${sheetMetal}`).ignoreNBT(),
      Ingredient.of(`tfc:metal/double_ingot/${sheetMetal}`).ignoreNBT(),
      mold
    )
    recipesEvent.recipes.immersiveengineeringArcFurnace(
      Ingredient.of(`tfc:metal/double_sheet/${sheetMetal}`).ignoreNBT(),
      Ingredient.of(`tfc:metal/sheet/${sheetMetal}`).ignoreNBT(),
      Ingredient.of(`tfc:metal/sheet/${sheetMetal}`).ignoreNBT()
    )
    recipesEvent.recipes.immersiveengineeringArcFurnace(
  ...
  recipesEvent.recipes.immersiveengineeringArcFurnace(
    ...
    Ingredient.of(`firmalife:metal/sheet/stainless_steel`).ignoreNBT(),
    Ingredient.of(`firmalife:metal/sheet/stainless_steel`).ignoreNBT()
  )
  recipesEvent.recipes.immersiveengineeringArcFurnace(
    `firmalife:metal/double_ingot/stainless_steel`,
    Ingredient.of(`firmalife:metal/ingot/stainless_steel`).ignoreNBT(),
    Ingredient.of(`firmalife:metal/ingot/stainless_steel`).ignoreNBT()
  )
  ...
  for (const rodMetal of rodMetals) {
    recipesEvent.recipes
      .immersiveengineeringMetalPress(
        `2x tfc:metal/rod/${rodMetal}`,
        Ingredient.of(`tfc:metal/ingot/${rodMetal}`).ignoreNBT(),
        "immersiveengineering:mold_rod"
      )
      .id(`kubejs:immersivemetalpress/rod/${rodMetal}`)
  }

  recipesEvent.recipes.immersiveengineeringMetalPress(
    `2x firmalife:metal/rod/chromium`,
    Ingredient.of(`firmalife:metal/ingot/chromium`).ignoreNBT(),
    "immersiveengineering:mold_rod"
  )
  recipesEvent.recipes.immersiveengineeringMetalPress(
    `2x firmalife:metal/rod/stainless_steel`,
    Ingredient.of(`firmalife:metal/ingot/stainless_steel`).ignoreNBT(),
    "immersiveengineering:mold_rod"
  )
  ...
  ie_Metals.forEach((ingot) => {
    recipesEvent.recipes.thermal
      .press(
        ...
        Ingredient.of(`#forge:ingots/${ingot}`)
      )
      .id(`kubejs:thermal/press/plate/${ingot}`)
  })
  recipesEvent.recipes.thermal
    .press("beyond_earth:desh_plate", Ingredient.of("beyond_earth:desh_ingot"))
    .id(`kubejs:thermal/press/plate/desh`)
  recipesEvent.recipes.thermal
    .press("create:brass_sheet", Ingredient.of("#forge:ingots/brass"))
    .id(`kubejs:thermal/press/plate/brass`)
  recipesEvent.recipes.thermal
    .press("createaddition:zinc_sheet", Ingredient.of("#forge:ingots/zinc"))
    .id(`kubejs:thermal/press/plate/zinc`)

  const thermalIngots = ["tin", "bronze", "invar"]
  for (const ingot of thermalIngots) {
    recipesEvent.recipes
      .createPressing(
        `thermal:${ingot}_plate`,
        Ingredient.of(`#forge:ingots/${ingot}`)
      )
      .id(`kubejs:create/press/plate/${ingot}`)
  }

  recipesEvent.recipes.thermal
    .crucible(Fluid.of("minecraft:lava", 1000), "#forge:magma")
    .id(`kubejs:thermal/machines/crucible/tfc_magma_to_lava`)

  for (const stone of tfcStoneTypes) {
    recipesEvent.custom({
      type: "create:crushing",
      ingredients: [Ingredient.of(`tfc:rock/cobble/${stone}`).toJson()],
      results: [
    ...
    recipesEvent.recipes.immersiveengineeringCrusher(
      Item.of(`tfc:rock/gravel/${stone}`),
      Ingredient.of(`tfc:rock/cobble/${stone}`)
    ) // Secondary output format: {chance: 0.5, output: 'item:id'}
  }
  modifyShaped(recipesEvent, "tfc:candle", 4, [" S ", " I ", "   "], {
    S: "#forge:string",
    I: "#forge:wax"
  })
  ...
  recipesEvent.replaceInput(
    { type: "minecraft:crafting_shaped", mod: "waystones" },
    "minecraft:emerald",
    "tfc:gem/emerald"
  )
  ...
  for (const grain of grains) {
    ...
    recipesEvent.recipes
      .createMixing(`4x firmalife:food/${grain}_dough`, [
  ...
  recipesEvent
    .shapeless(`9x minecraft:charcoal`, ["#forge:storage_blocks/charcoal"])
  ...
  recipesEvent.recipes.createMixing(`firmalife:watering_can`, [
  ...
  recipesEvent
    .shapeless("integratedtunnels:part_exporter_world_block", [
  ...
  recipesEvent
    .shapeless("9x tfc:gem/lapis_lazuli", ["#forge:storage_blocks/lapis"])
  ...
  recipesEvent
    .shapeless("9x tfc:metal/ingot/tin", ["#forge:storage_blocks/tin"])
  ...
  recipesEvent
    .shapeless("9x tfc:metal/ingot/bronze", ["#forge:storage_blocks/bronze"])
  ...
  recipesEvent
    .shapeless("9x minecraft:gunpowder", ["#forge:storage_blocks/gunpowder"])
    .id("kubejs:gunpowder_block_revert")

  // Bamboo
  recipesEvent
    .shapeless("9x minecraft:bamboo", ["#forge:storage_blocks/bamboo"])
  ...
  recipesEvent.shapeless("9x thermal:tar", ["#forge:storage_blocks/tar"])

  for (const color of dyes) {
    dyeRecipes(recipesEvent, color)
  }

  recipesEvent.replaceOutput(
    { mod: "thermal" },
    "minecraft:leather",
    "tfc:large_raw_hide"
  )
  ...
  recipesEvent.replaceInput(
    { mod: "integrateddynamics", id: /ore\/flint/ },
    "minecraft:gravel",
    "#forge:gravel"
  )
  recipesEvent.replaceInput(
  ...
  recipesEvent.replaceInput(
    { mod: "integrateddynamics", id: /ore\/redstone/ },
    "#forge:ores/redstone",
    "#forge:cinnabar"
  )
  ...
  // Smallships
  recipesEvent.replaceInput(
    { mod: "smallships", type: "minecraft:crafting_shaped" },
    "minecraft:chest",
    "#balm:wooden_chests"
  )
  recipesEvent.replaceInput(
  ...
  for (const woodType of boatWoodTypes) {
    if (vanillaWoodTypesReplacement[woodType]) {
      recipesEvent.replaceInput(
        ...
        `tfc:wood/boat/${vanillaWoodTypesReplacement[woodType]}`
      )
    } else {
      recipesEvent.replaceInput(
        { mod: "smallships", type: "minecraft:crafting_shaped" },
        `minecraft:${woodType}_boat`,
        `tfc:wood/boat/${woodType}`
      )
    }
  }
  ...
  recipesEvent.recipes
    .createMixing(`2x minecraft:paper`, [
  ...
  recipesEvent
    .shaped(
      Item.of("immersiveengineering:treated_wood_horizontal", 8),
      ["PPP", "PBP", "PPP"],
      {
        P: "#minecraft:planks",
        B: {
