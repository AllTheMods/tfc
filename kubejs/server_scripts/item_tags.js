...
/**
 *
 * @param {Internal.TagEventJS} itemTagsEvent
 */
const setDyeAndFlowerTags = (itemTagsEvent) => {
  ...
  itemTagsEvent
    .get("forge:dandelions")
    .add(["minecraft:dandelion", "tfc:plant/dandelion"])
  itemTagsEvent
    .get("forge:blue_orchids")
    .add(["minecraft:blue_orchid", "tfc:plant/blue_orchid"])
  itemTagsEvent
    .get("forge:allium")
    .add(["minecraft:allium", "tfc:plant/allium"])
  itemTagsEvent
    .get("forge:oxeye_daisy")
    .add(["minecraft:oxeye_daisy", "tfc:plant/oxeye_daisy"])
  itemTagsEvent
    .get("forge:orange_tulip")
    .add(["minecraft:orange_tulip", "tfc:plant/tulip_orange"])
  itemTagsEvent
    .get("forge:pink_tulip")
    .add(["minecraft:pink_tulip", "tfc:plant/tulip_pink"])
  itemTagsEvent
    .get("forge:white_tulip")
    .add(["minecraft:white_tulip", "tfc:plant/tulip_white"])
  itemTagsEvent
    .get("forge:red_tulip")
    .add(["minecraft:red_tulip", "tfc:plant/tulip_red"])
...
const setItemTags = (itemTagsEvent) => {
  itemTagsEvent
    .get("forge:cokesourcez")
    .add(["minecraft:coal", "tfc:ore/lignite", "tfc:ore/bituminous_coal"])
  itemTagsEvent
    .get("forge:cokesource")
    .add(["tfc:ore/lignite", "tfc:ore/bituminous_coal"])
  ...
  itemTagsEvent
    .get("forge:cocoa_beans")
    .add("firmalife:food/roasted_cocoa_beans")
  itemTagsEvent
    .get("forge:carrots")
    .add(["tfc:food/carrot", "minecraft:carrot"])
  ...
  itemTagsEvent
    .get("forge:cinnabar")
    .add(["tfc:ore/cinnabar", "thermal:cinnabar"])
  ...
  itemTagsEvent.add("forge:apples", ["minecraft:apple", "tfc:food/red_apple"])
  ...
  for (const tfcWoodType of tfcWoodTypes) {
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`tfc:wood/planks/${tfcWoodType}_bookshelf`)
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`mcw_tfc_furn:${tfcWoodType}_bookshelf`)
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`mcw_tfc_furn:${tfcWoodType}_bookshelf_cupboard`)
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`mcw_tfc_furn:${tfcWoodType}_bookshelf_drawer`)
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`mcw_tfc_furn:${tfcWoodType}_lower_bookshelf_drawer`)
  }

  for (const vanillaWoodType of vanillaWoodTypes) {
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`tfc:wood/planks/${vanillaWoodType}_bookshelf`)
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`mcwfurnitures:${vanillaWoodType}_bookshelf`)
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`mcwfurnitures:${vanillaWoodType}_bookshelf_cupboard`)
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`mcwfurnitures:${vanillaWoodType}_bookshelf_drawer`)
    itemTagsEvent
      .get("forge:bookshelves")
      .add(`mcwfurnitures:${vanillaWoodType}_lower_bookshelf_drawer`)
  }

  for (const tfcStoneType of tfcStoneTypes) {
    for (const tfcOreType of tfcOreTypes) {
      itemTagsEvent
        .get(`forge:ores_in_ground/${tfcStoneType}`)
        .add(`tfc:ore/rich_${tfcOreType}/${tfcStoneType}`)
        .add(`tfc:ore/normal_${tfcOreType}/${tfcStoneType}`)
        .add(`tfc:ore/poor_${tfcOreType}/${tfcStoneType}`)
    }
    for (const tfcGemOreType of tfcGemOreTypes) {
      itemTagsEvent
        .get(`forge:ores_in_ground/${tfcStoneType}`)
        .add(`tfc:ore/${tfcGemOreType}/${tfcStoneType}`)
    }
  }

  for (const tfcMetalOreType of tfcMetalOreTypes) {
    itemTagsEvent
      .get(`forge:ores/${tfcMetalOreType}`)
      .remove(`#tfc:ores/${tfcMetalOreType}/poor`)
      .remove(`#tfc:ores/${tfcMetalOreType}/normal`)
      .remove(`#tfc:ores/${tfcMetalOreType}/rich`)
  }

  itemTagsEvent.get("forge:ores/apatite").removeAll()
  itemTagsEvent
    .get("forge:ores/aluminum")
    .remove([
  ...
  itemTagsEvent
    ...
    .remove(["beyond_earth:glacio_copper_ore", "#minecraft:copper_ores"])
  itemTagsEvent
    .get("forge:ores/diamond")
    .remove([
  ...
  itemTagsEvent
    .get("forge:ores/gold")
    .remove(["beyond_earth:venus_gold_ore", "#minecraft:gold_ores"])
  itemTagsEvent
    .get("forge:ores/iron")
    .remove([
  ...
  itemTagsEvent
    .get("forge:ores/lapis")
    .remove(["beyond_earth:glacio_lapis_ore", "#minecraft:lapis_ores"])
  itemTagsEvent
    .get("forge:ores/lead")
    .remove([
  ...
  itemTagsEvent
    .get("forge:ores/ruby")
    .remove(["thermal:deepslate_ruby_ore", "thermal:ruby_ore"])
  itemTagsEvent
    .get("forge:ores/sapphire")
    .remove(["thermal:deepslate_sapphire_ore", "thermal:sapphire_ore"])
  itemTagsEvent
    .get("forge:ores/silver")
    .remove([
  ...
  itemTagsEvent
    .get("forge:ores/sulfur")
    .remove(["thermal:deepslate_sulfur_ore", "thermal:sulfur_ore"])
  itemTagsEvent
    .get("forge:ores/tin")
    .remove([
  ...
  itemTagsEvent.get("tfc:deals_slashing_damage").add(["bloodmagic:soulscythe"])

  itemTagsEvent.get("tfc:deals_piercing_damage").add(["minecraft:trident"])
  ...
  const framedDrawerTypes = ["full", "half"]
  const framedDrawerSizes = ["one", "two", "four"]

  // Add slab for raw rock types
  for (const tfcStoneType of tfcStoneTypes) {
    itemTagsEvent.add("tfc:raw_rock_slabs", [
      `tfc:rock/raw/${tfcStoneType}_slab`
    ])
  }
}
